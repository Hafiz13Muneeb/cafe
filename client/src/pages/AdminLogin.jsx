...
const AdminLogin = () => {
  ...
  // Check for stored auth error from interceptor (e.g., blocked account)
  React.useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // result.error contains the error message from server
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#F5F5DC]">
      <div className="w-full max-w-md bg-white border-2 border-[#3E2723] shadow-[8px_8px_0px_0px_#3E2723] p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#3E2723]/60 mt-1">Enter your credentials to access the dashboard</p>
        </div>
